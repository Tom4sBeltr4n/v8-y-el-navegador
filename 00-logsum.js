...
Tras ello, crea el contexto de ejecución, donde corre el código de la página. Esto funciona a través de una pila de tareas abstracta. Para lograrlo, esquila, analiza o "parsea" el código de JS en el que detecta "palabras clave". Luego, crea el Abstract Syntax Tree, donde se hallan reescritos o reformateados los entes fundamentales de JS. Luego, lo interpreta y crea las tareas con base en lo que el AST le diga. Tras ello, genera "bytecode", un lenguaje más abstracto que el de la máquina o el binario, pero menos que JS. 
